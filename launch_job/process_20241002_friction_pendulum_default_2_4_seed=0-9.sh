...
if [ $? != 0 ]; then
  ...
  tmux send-keys -t friction_pendulum_default_2_4_0-9 "bash jobs/job_20241002_friction_pendulum_default_2_4_seed=0-9.sh" C-m
  echo "Launched jobs/job_20241002_friction_pendulum_default_2_4_seed=0-9.sh at friction_pendulum_default_2_4_0-9"
